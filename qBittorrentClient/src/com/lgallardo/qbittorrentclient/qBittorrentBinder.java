...
public class qBittorrentBinder {
	...
	public qBittorrentBinder(String hostname,int port, String username, String password) {
		this(hostname, "http", port, username, password);
	}

	public qBittorrentBinder(String hostname, String protocol, int port, String username, String password) {
